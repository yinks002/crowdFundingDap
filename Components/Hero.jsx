...
const Hero = ({titleData, createCampaign}) => {
    ...
    overflow-hidden sm:max-w-xl md:max-w-full 
    lg:max-w-screen-xl md:px-24 
    lg:px-8 lg:py-20'>
        <div className='flex flex-col items-center justify-between xl:flex-row'>
            <div className='w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w7/12'>
            <h2 className='max-w-lg mb-6 font-sans text-3xl font-bold
            tracking-tight text-white sm:text-5xl sm:leading-none
            '>The yinks crowdfunding dapp <br className='hidden md:block'/>
            Crowd funding app bchain
            </h2>
            <p className='max-w-xl mb-4 text-base text-gray-200 md:text-lg'>
                Lorem ipsum dolor sit amet 
                consectetur, adipisicing elit.
                 Mollitia, quia? Consectetur, quas. 
                 Dolorum ut, qui molestias eius nesciunt 
             
            </p>
            <a href="/"
            aria-label=''
            className='inline-flex items-center 
            font-semibold tracking-wider transiton-colors 
            duration-200 text-teal-accent-400 
        ...
        <div className='bg-white rounded shadow-2xl p-7 sm:p-10'>
            ...
            <form>
                <div className='mb-1 sm:mb-2'>
                    ...
                    rounded shadow-sm appeardance-none 
                ...
                <p className='text-x5 text-gray-600 sm:text-sm'>
