...
const Popup = ({setOpenModel, donate, donateFunction, getDonations}) => {
    ...
    return (
        ...
        '>
            ...
            '>
                ...
                <div className='flex items-start justify-between p-5 border-b border-solid border-slate-200 rounded-t'>
                    ...
                    <button className='p-1 ml-auto bg-transparent border-0 text-black
        ...
        bg-white border border-gray-300 rounded shadow-sm appearance-none focus:border-deep-purple-accent-400
         ...
         {allDonationData?.map((donate, i)=>(
            ...
            {donate.donator.slice(0, 35)}
                ...
                border-slate-200 rounded-b'>
                    ...
                    <button className='background text-white  activr:bg-emerald-600
                    font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none
