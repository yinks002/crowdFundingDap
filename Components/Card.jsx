        ...
        {allcampaign?.map((campaign,i)=>(
            ...
            >
                ...
                <div className='py-5 pl-2'>
                    ...
                    <a href='/'
                    aria-label='Article'
                    className='inline-block mb-3 text-back transition-colors duration-200 hover:text-deep-purple-accent-700'
                    >
                        <p className='text-2xl font-bold loading-5'>{campaign.title}</p>

                    </a>
                    <p className='mb-4 text-gray-700'>{campaign.description}</p>
                    <div className='flex space-x-4'>
                        <p className='font-semibold'>Target: {campaign.target} ETH</p>
                        <p className='font-semibolf'>
